/**
 * Example Basic
 * https://github.dev/wellyshen/react-cool-virtual
 * */
...
>({
    ...
    const scrollToIndex = useCallback(
        (
            ...
            if (
                ...
                scrollOffset =
                    start + size <= outerSize ? 0 : start - outerSize + size;
            } else if (
                align === Align.center &&
    ...
    const [resetIsScrolling, cancelResetIsScrolling] = useDebounceFunc(

...
export const filled = {
    amber: "",
    black: "",
    blue: "bg-blue-500 text-white shadow-gray-500/20 hover:shadow-blue-500/40 dark:text-white dark:hover:text-slate-300",
    gray: "",
    brown: "",
    current: "",
    cyan: "",
...
export const text = {
    amber: "",
    black: "",
    blue: "text-blue-500 hover:bg-blue-500/10 active:bg-blue-500/30 dark:text-white dark:hover:text-slate-300",
    brown: "",
    current: "",
    cyan: "",
    "deep-orange": "",
    "deep-purple": "",
    gray: "text-gray-700 hover:bg-gray-700/10 active:bg-gray-700/30 dark:text-slate-200 dark:hover:text-slate-300",
